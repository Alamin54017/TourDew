...
public class GuiderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_guider, container, false);

        List<Guide> DataList=new ArrayList<>();

        recentRecycler= v.findViewById(R.id.guider);
        RecyclerView.LayoutManager layoutManager= new LinearLayoutManager(getContext(),RecyclerView.VERTICAL,false);
        recentRecycler.setLayoutManager(layoutManager);
        GuiderAdapter=new GuiderAdapter(getContext(),DataList);
        recentRecycler.setAdapter(GuiderAdapter);

        database.getReference().child("Guiders").addValueEventListener(new ValueEventListener() {
            @Override
