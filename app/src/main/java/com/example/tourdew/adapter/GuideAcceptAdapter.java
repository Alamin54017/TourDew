...
public class GuideAcceptAdapter extends RecyclerView.Adapter<GuideAcceptAdapter.ViewHolder> {
    Context context;
    List<GuideRequest> DataList;

    public GuideAcceptAdapter(Context context, List<GuideRequest> dataList) {
    ...
    @NonNull
    @Override
    public GuideAcceptAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.guidebooked,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GuideAcceptAdapter.ViewHolder holder, int position) {
        ...
        holder.chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("userid",DataList.get(position).getSenderId());
